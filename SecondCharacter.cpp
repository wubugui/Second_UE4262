...
void ASecondCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Crouch", EInputEvent::IE_Pressed, this, &ASecondCharacter::BeginCrouch);

	PlayerInputComponent->BindAction("Crouch", IE_Released, this, &ASecondCharacter::EndCrouch);
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ASecondCharacter::OnResetVR);
}


void ASecondCharacter::OnResetVR()
{
	// If Second is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Second.Build.cs is not automatically propagated
...
void ASecondCharacter::BeginCrouch()
{
	Crouch();
}

void ASecondCharacter::EndCrouch()
{
	UnCrouch();
}
